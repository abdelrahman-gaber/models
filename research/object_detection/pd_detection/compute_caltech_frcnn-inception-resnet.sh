...
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/tensorflow-detection/CaltechTest-frcnn_inception_resnet_v2
...
do
    ...
    mkdir -p $save_folder
    python pd_detection.py -images $source_folder -output $save_folder -model faster_rcnn_inception_resnet_v2_atrous_coco_11_06_2017 -thresh 0.0
