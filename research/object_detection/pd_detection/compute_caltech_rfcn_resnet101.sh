...
#OAR -p gpu='YES' and host='nefgpu15.inria.fr' and cluster='dellt630gpu'
...
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/tensorflow-detection/CaltechTest-rfcn-resnet101
...
do
    ...
    mkdir -p $save_folder
    python pd_detection.py -images $source_folder -output $save_folder -model rfcn_resnet101_coco_11_06_2017 -thresh 0.0
